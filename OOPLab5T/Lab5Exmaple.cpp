...
void exersice1() {
  ...
  PIB ol("Olexander", "Vanzuriak", "Hruhorovitch", 1, 3454);
  ol.print();
  cout << endl;
...
void exersice2() {
    ...
    r.print();
    cout << endl;
    cout << "Create one room apartment with 12 meters kitchen and 3 floor" << endl;
    oneRoomApartment room(r, 12, 3);
    room.print();
    cout << endl;
